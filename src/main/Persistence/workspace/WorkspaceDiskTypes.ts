...
export type PromptFolderCategoryOrderFile = import('@shared/domain/prompt-folder/PromptFolder').CategoryOrder
...
import type { EntryRef, FolderEntryRef, OrderContainer } from '@shared/domain/OrderContainer'
