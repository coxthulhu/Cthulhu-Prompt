...
export const PROMPT_FOLDER_SETTINGS_TITLE_AREA_HEIGHT_PX = 95
...
const SETTINGS_HEADER_HEIGHT_PX =
  SETTINGS_TOP_PADDING_PX + TITLE_PAGE_LINE_HEIGHT_PX
...
export const PROMPT_HEADER_ROW_HEIGHT_PX =
  PROMPT_HEADER_PADDING_TOP_PX + TITLE_PAGE_LINE_HEIGHT_PX + PROMPT_HEADER_PADDING_BOTTOM_PX
