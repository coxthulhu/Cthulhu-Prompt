...
/** Shared title height for editor-card detail sections. */
export const EDITOR_CARD_SECTION_HEADER_HEIGHT_PX = 28
export const PROMPT_EDITOR_COMPACT_LAYOUT_MAX_WIDTH_PX = 720
export const PROMPT_TEMPLATE_EDITOR_COMPACT_LAYOUT_MAX_WIDTH_PX = 480
