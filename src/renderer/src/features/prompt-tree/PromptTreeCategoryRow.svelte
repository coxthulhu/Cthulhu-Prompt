<script lang="ts">
  ...
  import RotatingChevron from '@renderer/common/cthulhu-ui/layout/RotatingChevron.svelte'
  import type { Category } from '@shared/domain/category/Category'
  import type { Action } from 'svelte/action'
  import { draggable } from '@renderer/common/drag-drop/dragDrop.svelte.ts'
...
{#snippet categoryRowChildren()}
  ...
  >
    ...
    />
    <IconCell icon={Folder} iconClass="sidebarPromptTreeCategoryIcon" variant="small" />
...
{#snippet categoryContentTarget(categoryOrderIsOver = false)}
  {#if getCategoryContentDroppableOptions}
    <DropTarget getOptions={getCategoryContentDroppableOptions}>
