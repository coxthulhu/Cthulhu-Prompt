<script lang="ts">
  ...
  const createPrompt = (
    ...
    categoryLabel: title.includes('Review')
      ? 'Review'
  ...
  let categories = $state<MockCategory[]>([
  ...
  const addCategory = () => {
    categories.push({ name: 'New Category', id: 'new-category' })
  }

  const removeCategory = (category: MockCategory) => {
        ...
        <div class="base-prompt-title-main">
          ...
          <div class="base-title-copy">
            ...
            <div class="base-metadata-row">
              <span class="category-prompt-label" title={`Category: ${prompt.categoryLabel}`}>
    ...
    <section class="base-root-header">
      <div class="base-root-title-row">
        ...
        <div class="category-root-actions">
          {@render IconButton(Tags, 'Manage Categories', {
            hoverVariant: 'accent',
            active: categoryDialogOpen,
            ariaPressed: categoryDialogOpen,
            onclick: () => {
...
{#if categoryDialogOpen}
  <div
    ...
    role="presentation"
    data-testid="category-dialog-layer"
    ...
    >
      <header class="category-dialog-header">
        <div class="category-dialog-heading">
          ...
          <div class="category-dialog-heading-copy">
            ...
            <p>Create and organize categories for prompts in Product Work.</p>
          </div>
        </div>
      ...
      <div class="category-dialog-body">
        <div class="category-list-header">
          ...
          <button type="button" class="category-add-button" onclick={addCategory}>
            <Plus size={16} aria-hidden="true" />
            Add Category
          </button>
        </div>

        <div class="category-field-labels" aria-hidden="true">
          <span>Name</span>
          <span>ID</span>
          <span></span>
        </div>
          ...
          {#each categories as category (category)}
            <div class="category-row">
              <div class="category-name-field">
                ...
                <input aria-label="Category name" bind:value={category.name} />
              </div>
              <div class="category-id-field">
                <span aria-hidden="true">#</span>
                <input aria-label="Category ID" bind:value={category.id} />
              </div>
        ...
        <p class="category-helper-text">Category IDs are used to identify categories and must be unique.</p>
      </div>

      {@render Separator()}

      <footer class="category-dialog-footer">
        <button type="button" class="base-dialog-cancel-button" onclick={closeCategoryDialog}>
          Cancel
        </button>
...
<style>
  ...
  .category-dialog-heading-copy h2 {
    color: var(--ui-normal-text);
    font-size: 19px;
    font-weight: 650;
    line-height: 24px;
  ...
  .category-dialog-heading-copy p {
    color: var(--ui-muted-text);
    font-size: 13px;
    line-height: 19px;
    margin: 3px 0 0;
  ...
  .category-row + .category-row {
    border-top: 1px solid var(--ui-card-nested-border);
  }
  ...
  .category-row:nth-child(2) .category-swatch {
    background: var(--ui-warning-icon-glyph);
  }

  .category-row:nth-child(3) .category-swatch {
    background: var(--ui-success-normal-text);
  }

  .category-row:nth-child(4) .category-swatch {
  ...
  .category-name-field:focus-within,
  .category-id-field:focus-within {
