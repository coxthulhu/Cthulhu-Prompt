<script lang="ts">
  ...
  let categoriesDialogOpen = $state(true)
  ...
  const promptCategories: Record<string, string> = {
    ...
    'base-build': 'Implementation',
    'base-regression': 'Verification'
  }
  ...
  const handleCategoriesDialogLayerClick = (event: MouseEvent) => {
    if (event.target === event.currentTarget) closeCategoriesDialog()
  }
  ...
  // Side effect: let Escape dismiss the visible category manager like the app's dialogs.
  $effect(() => {
    if (!categoriesDialogOpen) return

    const handleKeydown = (event: KeyboardEvent) => {
      if (event.key === 'Escape') closeCategoriesDialog()
    }
    document.addEventListener('keydown', handleKeydown)
        ...
        <div class="base-prompt-title-main">
          ...
          <div class="base-title-copy">
            ...
            <div class="base-metadata-row">
              <span class="category-prompt-chip">
                <Tag size={11} aria-hidden="true" />
                {promptCategories[prompt.id]}
              </span>
              {@render SeparatorDot()}
              <span
  ...
  <div class="base-content-viewport">
    <section class="base-root-header">
      <div class="base-root-title-row">
        ...
        <div class="category-root-actions">
          <button
            type="button"
...
{#if categoriesDialogOpen}
  <div
    ...
    onclick={handleCategoriesDialogLayerClick}
  >
    <div
      class="base-template-dialog categories-dialog"
      role="dialog"
      aria-modal="true"
      aria-labelledby="manage-categories-title"
    >
      <header class="base-template-dialog-header categories-dialog-header">
        <div class="base-template-dialog-heading">
          <div class="categories-dialog-icon">
          ...
          <div class="base-template-dialog-heading-copy">
            ...
            <p>Categories for Product Work</p>
          </div>
        </div>
        {@render IconButton(X, 'Close', { onclick: closeCategoriesDialog })}
      </header>

      <div class="categories-summary-bar">
        <div>
          <strong>8 categories</strong>
          <span>Available to every prompt in this folder</span>
        </div>
        <button type="button" class="categories-add-button">
          <Plus size={16} aria-hidden="true" />
          Add Category
        </button>
      </div>
      ...
      <div class="categories-table">
        <div class="categories-table-header" aria-hidden="true">
          <span>Name</span>
          <span>ID</span>
          <span></span>
        </div>
        ...
        <div class="category-edit-row">
          <span class="category-color category-color-discovery" aria-hidden="true"></span>
          <input aria-label="Category name" value="Discovery" />
          <input aria-label="Category ID" value="discovery" />
          {@render IconButton(Trash2, 'Remove Discovery', {
            size: 'compact',
            borderless: true,
            hoverVariant: 'danger'
          })}
        ...
        <div class="category-edit-row">
          <span class="category-color category-color-requirements" aria-hidden="true"></span>
          <input aria-label="Category name" value="Requirements" />
          <input aria-label="Category ID" value="requirements" />
          {@render IconButton(Trash2, 'Remove Requirements', {
            size: 'compact',
            borderless: true,
            hoverVariant: 'danger'
          })}
        ...
        <div class="category-edit-row">
          <span class="category-color category-color-planning" aria-hidden="true"></span>
          <input aria-label="Category name" value="Planning" />
          <input aria-label="Category ID" value="planning" />
          {@render IconButton(Trash2, 'Remove Planning', {
            size: 'compact',
            borderless: true,
            hoverVariant: 'danger'
          })}
        ...
        <div class="category-edit-row">
          <span class="category-color category-color-implementation" aria-hidden="true"></span>
          <input aria-label="Category name" value="Implementation" />
          <input aria-label="Category ID" value="implementation" />
          {@render IconButton(Trash2, 'Remove Implementation', {
            size: 'compact',
            borderless: true,
            hoverVariant: 'danger'
          })}
        ...
        <div class="category-edit-row">
          <span class="category-color category-color-verification" aria-hidden="true"></span>
          <input aria-label="Category name" value="Verification" />
          <input aria-label="Category ID" value="verification" />
          {@render IconButton(Trash2, 'Remove Verification', {
            size: 'compact',
            borderless: true,
            hoverVariant: 'danger'
          })}
        ...
        <div class="category-edit-row">
          <span class="category-color category-color-review" aria-hidden="true"></span>
          <input aria-label="Category name" value="Review" />
          <input aria-label="Category ID" value="review" />
          {@render IconButton(Trash2, 'Remove Review', {
            size: 'compact',
            borderless: true,
            hoverVariant: 'danger'
          })}
        ...
        <div class="category-edit-row">
          <span class="category-color category-color-documentation" aria-hidden="true"></span>
          <input aria-label="Category name" value="Documentation" />
          <input aria-label="Category ID" value="documentation" />
          {@render IconButton(Trash2, 'Remove Documentation', {
            size: 'compact',
            borderless: true,
            hoverVariant: 'danger'
          })}
        ...
        <div class="category-edit-row">
          <span class="category-color category-color-handoff" aria-hidden="true"></span>
          <input aria-label="Category name" value="Handoff" />
          <input aria-label="Category ID" value="handoff" />
          {@render IconButton(Trash2, 'Remove Handoff', {
            size: 'compact',
            borderless: true,
            hoverVariant: 'danger'
          })}
      ...
      <footer class="base-template-dialog-footer categories-dialog-footer">
...
<style>
  ...
  .category-manage-button:focus-visible {
    background: var(--ui-neutral-action-hover-fill);
    border-color: var(--ui-neutral-hover-border);
  }

  .category-prompt-chip {
    align-items: center;
    background: color-mix(in srgb, var(--ui-accent-action-fill) 72%, transparent);
  ...
  .categories-summary-bar strong {
    color: var(--ui-normal-text);
    font-size: 14px;
    font-weight: 600;
  }

  .categories-summary-bar span {
    color: var(--ui-muted-text);
    font-size: 12px;
  }
  ...
  .categories-add-button:hover,
  .categories-add-button:focus-visible {
    background: var(--ui-accent-action-hover-fill);
    border-color: var(--ui-accent-muted-hover-border);
  }
  ...
  .categories-table {
    border-bottom: 1px solid var(--ui-neutral-muted-border);
    border-top: 1px solid var(--ui-neutral-muted-border);
    max-height: min(430px, calc(100vh - 275px));
    overflow-y: auto;
  }
  ...
  .category-edit-row {
    ...
    display: grid;
    gap: 10px;
    grid-template-columns: minmax(0, 1.05fr) minmax(0, 1fr) 28px;
    padding-left: 50px;
    padding-right: 18px;
  }
  ...
  .categories-table-header + .category-edit-row {
    border-top: 0;
  }

  .category-edit-row:nth-child(odd) {
    background: color-mix(in srgb, var(--ui-card-normal-surface) 55%, transparent);
  }
  ...
  .category-edit-row input:hover {
    border-color: var(--ui-neutral-hover-border);
  }

  .category-color {
    background: var(--ui-accent-normal-border);
    border: 2px solid var(--ui-card-solid-surface);
    border-radius: 999px;
    box-shadow: 0 0 0 1px var(--ui-neutral-normal-border);
    height: 12px;
    left: 24px;
    position: absolute;
    width: 12px;
  ...
  .category-color-requirements,
  .category-color-review {
    background: var(--ui-success-normal-border);
  }

  .category-color-planning,
  .category-color-documentation {
    background: var(--ui-hoverable-icon-glyph);
  }

  .category-color-implementation,
  .category-color-handoff {
    background: var(--ui-danger-icon-glyph);
  }
