...
{#snippet EdgeInsertRow(previousPromptId: string | null, targetFolderId: string | null)}
  {@const promptTestId = previousPromptId
  ...
  {@const subfolderTestId = previousPromptId
  ...
  <div class="mockup-edge-insert">
    <div class="mockup-edge-insert-actions" role="toolbar" aria-label="Add at this row boundary">
      <button
        class="mockup-edge-insert-button"
        type="button"
...
{#snippet SubfolderDividerRow(previousFolder: MockSubfolder)}
  ...
  <div class="mockup-edge-insert mockup-edge-insert-between-folders">
    <div class="mockup-edge-insert-actions" role="toolbar" aria-label="Add at this folder boundary">
      <button
        class="mockup-edge-insert-button"
        type="button"
        aria-label="Add prompt to previous folder"
        title="Add prompt to previous folder"
...
<style>
  ...
  .mockup-edge-insert-actions::before {
  ...
  .mockup-edge-insert-button:first-child {
    background: var(--ui-neutral-subtle-action-hover-fill);
    color: var(--ui-hoverable-icon-glyph);
  }

  .mockup-edge-insert-button:hover {
    background: var(--ui-accent-action-hover-fill);
    color: var(--ui-accent-normal-text);
  }

  .mockup-edge-insert-button:focus-visible {
    box-shadow: inset 0 0 0 2px var(--ui-hoverable-icon-glyph);
  }

  .mockup-child-editor-row .mockup-edge-insert-actions {
    left: -20px;
  }

  .mockup-edge-insert-between-folders .mockup-edge-insert-actions {
    border-color: var(--ui-info-strong-border);
  }
