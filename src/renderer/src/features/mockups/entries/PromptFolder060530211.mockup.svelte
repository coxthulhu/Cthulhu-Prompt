<script lang="ts">
  ...
  const iconTileStyle =
    'align-items:center;background:var(--ui-accent-icon-surface);border:1px solid var(--ui-accent-normal-border);border-radius:7px;box-shadow:0 0 0 1px var(--ui-accent-icon-ring) inset;color:var(--ui-accent-icon-glyph);display:flex;height:40px;justify-content:center;width:40px;'
