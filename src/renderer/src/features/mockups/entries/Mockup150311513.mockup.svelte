<script lang="ts">
  ...
  const handleCategoryDialogLayerClick = (event: MouseEvent) => {
  ...
  // Side effect: mirror the live dialogs' Escape-key dismissal while a mock dialog is open.
  $effect(() => {
    if (!templateDialogPrompt && !categoryDialogOpen) return

    const handleKeydown = (event: KeyboardEvent) => {
      if (event.key !== 'Escape') return
      if (categoryDialogOpen) closeCategoryDialog()
      else closeTemplateDialog()
    }
  ...
  const categoryNames = ['Research', 'Planning', 'Engineering', 'Review']
</script>
        ...
        <div class="base-prompt-title-main">
          ...
          <div class="base-title-copy">
            ...
            <div class="base-metadata-row">
              ...
              {@render SeparatorDot()}
              <span class="base-category-label">
...
{#if categoryDialogOpen}
  <div
    ...
    onclick={handleCategoryDialogLayerClick}
  >
    <div
      class="base-template-dialog base-category-dialog"
      role="dialog"
      aria-modal="true"
    ...
    >
      <header class="base-template-dialog-header">
        <div class="base-template-dialog-heading">
          <div class="base-category-dialog-icon">
      ...
      <div class="base-category-dialog-body">
        <div class="base-category-toolbar">
          <div>
        ...
        <div class="base-category-column-labels" aria-hidden="true">
          <span>Name</span>
          <span>ID</span>
          <span>Actions</span>
        </div>
        ...
        <div class="base-category-list">
          <div class="base-category-row base-category-row-editing">
            <div class="base-category-swatch" data-color="research"></div>
            <label>
              <span class="base-visually-hidden">Category name</span>
              <input value="Research" aria-label="Category name" />
            </label>
            <label>
              <span class="base-visually-hidden">Category ID</span>
              <input value="research" aria-label="Category ID" />
            </label>
            <div class="base-category-row-actions">
              {@render IconButton(Check, 'Save Research category', {
                size: 'compact',
                hoverVariant: 'success'
              })}
              {@render IconButton(Trash2, 'Remove Research category', {
                size: 'compact',
                hoverVariant: 'danger'
              })}
            </div>
          ...
          <div class="base-category-row">
            <div class="base-category-swatch" data-color="planning"></div>
            <span class="base-category-name">Planning</span>
            <code>planning</code>
            <div class="base-category-row-actions">
              {@render IconButton(Pencil, 'Edit Planning category', { size: 'compact' })}
              {@render IconButton(Trash2, 'Remove Planning category', {
                size: 'compact',
                hoverVariant: 'danger'
              })}
            </div>
          ...
          <div class="base-category-row">
            <div class="base-category-swatch" data-color="engineering"></div>
            <span class="base-category-name">Engineering</span>
            <code>engineering</code>
            <div class="base-category-row-actions">
              {@render IconButton(Pencil, 'Edit Engineering category', { size: 'compact' })}
              {@render IconButton(Trash2, 'Remove Engineering category', {
                size: 'compact',
                hoverVariant: 'danger'
              })}
            </div>
          ...
          <div class="base-category-row">
            <div class="base-category-swatch" data-color="review"></div>
            <span class="base-category-name">Review</span>
            <code>review</code>
            <div class="base-category-row-actions">
              {@render IconButton(Pencil, 'Edit Review category', { size: 'compact' })}
              {@render IconButton(Trash2, 'Remove Review category', {
                size: 'compact',
                hoverVariant: 'danger'
              })}
            </div>
        ...
        <button type="button" class="base-new-category-row">
          <Plus size={16} aria-hidden="true" />
          <span>Create another category</span>
        </button>
      </div>

      <footer class="base-template-dialog-footer base-category-dialog-footer">
        <button type="button" class="base-dialog-confirm-button" onclick={closeCategoryDialog}>
          Done
        </button>
      </footer>
    </div>
...
<style>
  ...
  .base-category-dialog {
    max-width: 660px;
    padding: 20px 18px 18px;
  }

  .base-category-dialog-icon {
    align-items: center;
    background: var(--ui-accent-action-fill);
  ...
  .base-category-toolbar > div {
    align-items: baseline;
    display: flex;
    gap: 8px;
  }

  .base-category-toolbar strong {
    color: var(--ui-normal-text);
    font-size: 14px;
    font-weight: 600;
  }

  .base-category-toolbar > div span {
    color: var(--ui-muted-text);
    font-size: 12px;
  }
  ...
  .base-category-column-labels,
  .base-category-row {
    display: grid;
    grid-template-columns: minmax(130px, 1fr) minmax(120px, 0.9fr) 84px;
  }
  ...
  .base-category-column-labels span:last-child {
    text-align: right;
  }
  ...
  .base-category-row-editing {
    border-color: var(--ui-accent-normal-border);
    box-shadow: inset 0 0 0 1px var(--ui-accent-muted-border);
    gap: 8px;
  }

  .base-category-swatch {
    background: var(--ui-accent-normal-text);
    border-radius: 999px;
    height: 8px;
    left: 11px;
    position: absolute;
  ...
  .base-category-swatch[data-color='planning'] {
    background: var(--ui-warning-icon-glyph);
  }

  .base-category-swatch[data-color='engineering'] {
    background: var(--ui-success-normal-text);
  }

  .base-category-swatch[data-color='review'] {
  ...
  .base-category-row code {
    color: var(--ui-secondary-text);
    font-family: inherit;
    font-size: 12px;
  }

  .base-category-row label {
    min-width: 0;
  }

  .base-category-row input {
    background: var(--ui-editor-content-surface);
    border: 1px solid var(--ui-neutral-normal-border);
    border-radius: var(--cthulhu-ui-radius-control);
    box-sizing: border-box;
  ...
  .base-category-row-actions {
    display: flex;
    gap: 4px;
    justify-content: flex-end;
  }

  .base-new-category-row {
    align-items: center;
    background: transparent;
    border: 1px dashed var(--ui-neutral-normal-border);
    border-radius: var(--cthulhu-ui-radius-control);
    color: var(--ui-secondary-text);
    display: flex;
    font-size: 13px;
  ...
  .base-new-category-row:hover {
    background: var(--ui-neutral-subtle-action-hover-fill);
    border-color: var(--ui-neutral-hover-border);
    color: var(--ui-hoverable-text);
  }

  .base-category-dialog-footer {
    padding-top: 14px;
  }

  .base-category-dialog-footer .base-dialog-confirm-button {
    justify-content: center;
    min-width: 88px;
  }
