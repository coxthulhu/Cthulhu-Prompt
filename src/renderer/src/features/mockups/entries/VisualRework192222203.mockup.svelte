<script lang="ts">
  ...
  const getEditorUri = (documentId: string) =>
    monaco.Uri.file(`/cthulhu-prompt/mockups/visual-rework-192222203/${documentId}.md`)
    ...
    <article class="base-editor-card base-folder-card">
      ...
      <div class="base-editor-body">
        ...
        <div class="base-folder-settings">
          <div class="base-settings-overview">
            <div class="base-settings-overview-copy">
              <span class="base-settings-overview-title">Folder settings</span>
