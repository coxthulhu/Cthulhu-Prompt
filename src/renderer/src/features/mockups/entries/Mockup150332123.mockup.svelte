<script lang="ts">
  ...
  const createPrompt = (
    ...
    categoryName:
      id.includes('review')
        ? 'Review'
        : id.includes('docs') || id.includes('handoff')
          ? 'Documentation'
          : id.includes('plan') || id.includes('requirements')
            ? 'Planning'
            : 'Engineering',
    id,
    title,
        ...
        <div class="base-prompt-title-main">
          ...
          <div class="base-title-copy">
            ...
            <div class="base-metadata-row">
              <span class="category-prompt-label">
  ...
  >
    ...
    >
      <header class="category-dialog-header">
        <div class="category-dialog-heading">
          <div class="category-dialog-icon">
            <Tags size={23} aria-hidden="true" />
          </div>
          <div class="category-dialog-heading-copy">
            <h2 id="category-dialog-title">Manage Categories</h2>
            <p id="category-dialog-description">Categories for Product Work</p>
          </div>
        </div>
        {@render IconButton(X, 'Close', { onclick: closeCategoryDialog })}
      </header>
      ...
      <div class="category-dialog-body">
        <div class="category-list-toolbar">
          ...
          <button type="button" class="category-add-button">
            <Plus size={16} aria-hidden="true" />
        ...
        <div class="category-list" role="list">
          <div class="category-list-labels" aria-hidden="true">
            <span>Name</span>
            <span>ID</span>
            <span>Actions</span>
          </div>
          ...
          <div class="category-row" role="listitem">
            <div class="category-name-control">
              <span class="category-swatch category-swatch-planning"></span>
              <input aria-label="Category name" value="Planning" />
            </div>
            <div class="category-id-control">
              <span>category/</span>
              <input aria-label="Category ID" value="planning" />
            </div>
            {@render IconButton(Trash2, 'Delete Planning category', {
              hoverVariant: 'danger',
              size: 'compact'
            })}
          </div>
          ...
          <div class="category-row" role="listitem">
            <div class="category-name-control">
              <span class="category-swatch category-swatch-engineering"></span>
              <input aria-label="Category name" value="Engineering" />
            </div>
            <div class="category-id-control">
              <span>category/</span>
              <input aria-label="Category ID" value="engineering" />
            </div>
            {@render IconButton(Trash2, 'Delete Engineering category', {
              hoverVariant: 'danger',
              size: 'compact'
            })}
          </div>
          ...
          <div class="category-row" role="listitem">
            <div class="category-name-control">
              <span class="category-swatch category-swatch-review"></span>
            ...
            {@render IconButton(Trash2, 'Delete Review category', {
              hoverVariant: 'danger',
              size: 'compact'
            })}
          </div>
          ...
          <div class="category-row" role="listitem">
            <div class="category-name-control">
              <span class="category-swatch category-swatch-documentation"></span>
            ...
            {@render IconButton(Trash2, 'Delete Documentation category', {
              hoverVariant: 'danger',
              size: 'compact'
            })}
          </div>
      ...
      <footer class="category-dialog-footer">
...
<style>
  ...
  .category-dialog {
    ...
    border-radius: var(--cthulhu-ui-radius-card);
    box-shadow: 0 12px 32px var(--ui-card-normal-shadow);
    box-sizing: border-box;
    color: var(--ui-normal-text);
    display: flex;
    flex-direction: column;
  ...
  .category-dialog-heading-copy {
    min-width: 0;
  }

  .category-dialog-heading h2 {
    color: var(--ui-normal-text);
    font-size: 18px;
    font-weight: 600;
    line-height: 24px;
  ...
  .category-list-toolbar > div > span {
    color: var(--ui-muted-text);
    font-size: 12px;
  }
  ...
  .category-row {
    ...
    display: grid;
    gap: 12px;
    grid-template-columns: minmax(170px, 1fr) minmax(210px, 1.1fr) 52px;
    min-width: 0;
  }
  ...
  .category-list-labels span:last-child {
    text-align: center;
  }
  ...
  .category-name-control input,
  .category-id-control input {
    background: transparent;
    border: 0;
    color: var(--ui-normal-text);
    font-size: 13px;
  ...
  .category-swatch {
    border-radius: 999px;
    box-shadow: 0 0 0 2px var(--ui-card-solid-surface);
    flex: 0 0 9px;
    height: 9px;
    width: 9px;
  }

  .category-swatch-planning {
    background: var(--ui-accent-normal-border);
  }

  .category-swatch-engineering {
    background: var(--ui-warning-icon-glyph);
  }

  .category-swatch-review {
    background: var(--ui-success-normal-text);
  }

  .category-swatch-documentation {
    background: var(--ui-secondary-icon-glyph);
  }

  .category-row > .base-icon-button {
    justify-self: center;
  }
