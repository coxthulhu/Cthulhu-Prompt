<script lang="ts">
  ...
  const accentTileStyle =
    'align-items:center;background:var(--ui-accent-normal-surface);border:1px solid var(--ui-accent-icon-ring);border-radius:7px;display:flex;height:40px;justify-content:center;width:40px;'
