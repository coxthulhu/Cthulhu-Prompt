    ...
    <article style={panelStyle}>
      <div style={sectionTitleStyle}>
        ...
        <div style="display: grid; gap: 3px; min-width: 0;">
          <h2 style="font-size: 1.28rem; font-weight: 700; letter-spacing: 0; line-height: 1.2; margin: 0;">
            Editor &amp; layout
          </h2>
          <p style="color: var(--ui-muted-text); font-size: 0.9rem; line-height: 1.4; margin: 0;">
