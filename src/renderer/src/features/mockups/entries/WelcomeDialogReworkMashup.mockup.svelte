...
{#if dialog}
  <div class="dialog-layer text-base" role="presentation" use:mountDialog onclick={(event) => { if (event.target === event.currentTarget && dialog === 'error') closeDialog() }}>
    <div class="home-dialog" style={dialog === 'welcome' ? 'max-width: 800px; padding: 0; border-radius: 14px; overflow: hidden;' : undefined} data-create={dialog === 'create'} data-welcome={dialog === 'welcome'} role="dialog" aria-modal="true" aria-label={dialog === 'create' ? 'Create Workspace' : dialog === 'welcome' ? 'Welcome' : 'Failed to Open Workspace'} tabindex="-1">
      <div class="dialog-header" style={dialog === 'welcome' ? 'padding: 22px 26px 18px;' : undefined}>
        ...
        <div class="text-sm leading-6" style="min-height: 0; overflow-y: auto; padding: 0 28px; color: var(--ui-hoverable-text);">
          <ol style="list-style: none; padding: 0; margin: 0;">
            <li style="display: grid; grid-template-columns: 44px minmax(0, 1fr); gap: 18px; padding: 20px 0; border-bottom: 1px solid var(--ui-neutral-muted-border);">
              ...
              <div>
                <h2 class="text-base leading-6 font-semibold" style="display: flex; align-items: center; gap: 9px; margin: 0 0 6px; color: var(--ui-normal-text);"><Home size={19} color="var(--ui-hoverable-icon-glyph)" aria-hidden="true" />Create a workspace</h2>
                ...
                <div class="text-sm leading-5" style="display: flex; align-items: center; gap: 8px; margin-top: 10px; color: var(--ui-muted-text);"><span style="display: flex; gap: 10px; padding: 5px 9px; border: 1px solid var(--ui-neutral-muted-border); border-radius: 5px;"><Home size={14} color="var(--ui-muted-icon-glyph)" /><FileText size={14} color="var(--ui-muted-icon-glyph)" /><Layers size={14} color="var(--ui-muted-icon-glyph)" /></span>Use the left-hand icon bar to switch screens.</div>
              </div>
            </li>
            ...
            <li style="display: grid; grid-template-columns: 44px minmax(0, 1fr); gap: 18px; padding: 18px 0; border-bottom: 1px solid var(--ui-neutral-muted-border);">
              <span class="text-xl leading-10 font-semibold" style="width: 42px; height: 42px; text-align: center; border: 1px solid var(--ui-accent-muted-border); border-radius: 50%; color: var(--ui-normal-text); background: var(--ui-accent-action-fill);">3</span>
              <div>
                <h2 class="text-base leading-6 font-semibold" style="display: flex; align-items: center; gap: 9px; margin: 0 0 6px; color: var(--ui-normal-text);"><FileText size={19} color="var(--ui-hoverable-icon-glyph)" aria-hidden="true" />Add a prompt task</h2>
                ...
                <div class="text-sm leading-5" style="display: flex; flex-wrap: wrap; align-items: center; gap: 7px; margin-top: 9px; color: var(--ui-muted-text);">Backlog<ArrowRight size={14} color="var(--ui-muted-icon-glyph)" />Todo<ArrowRight size={14} color="var(--ui-muted-icon-glyph)" />In Progress<ArrowRight size={14} color="var(--ui-muted-icon-glyph)" /><span style="color: var(--ui-normal-text);">Completed</span></div>
              </div>
            </li>
      ...
      {/if}
      <div class="separator"></div>
      <div class="dialog-footer" style={dialog === 'welcome' ? 'padding: 16px 26px; flex-wrap: wrap;' : undefined}>
        {#if dialog === 'welcome'}
