...
<ParamField
  ...
  optional
>
  The draggable types this droppable accepts, or a predicate function for custom acceptance logic.
</ParamField>
...
<ParamField path="collisionPriority" type="CollisionPriority | number | (() => CollisionPriority | number)" optional>
  Collision priority for this droppable when targets overlap.
</ParamField>
