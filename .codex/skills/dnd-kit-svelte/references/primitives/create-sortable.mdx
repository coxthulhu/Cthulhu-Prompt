...
<ParamField path="group" type="UniqueIdentifier | (() => UniqueIdentifier)" optional>
  The group this sortable belongs to. Used for sorting across multiple lists.
</ParamField>

<ParamField
  path="accept"
  type="Type | Type[] | ((source: Draggable) => boolean) | (() => Type | Type[] | ((source: Draggable) => boolean))"
  optional
>
  The types of draggable elements this sortable accepts.
</ParamField>

<ParamField path="type" type="Type | (() => Type)" optional>
  The type of this sortable element.
</ParamField>

<ParamField
  path="feedback"
  type="'default' | 'move' | 'clone' | 'none' | (() => 'default' | 'move' | 'clone' | 'none')"
  optional
>
  Controls how drag feedback is rendered.
</ParamField>

<ParamField path="alignment" type="Alignment | (() => Alignment)" optional>
  Alignment used for positioning dragged geometry.
</ParamField>

<ParamField path="plugins" type="PluginConstructor[] | (() => PluginConstructor[])" optional>
  Plugins to register when the sortable instance is created.
</ParamField>
...
<ParamField path="collisionPriority" type="CollisionPriority | number | (() => CollisionPriority | number)" optional>
