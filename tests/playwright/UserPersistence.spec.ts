...
describe('User Persistence', () => {
  ...
  test('renders all prompt tree rows on startup without show-all state', async ({
    electronApp,
    testSetup
  }) => {
  ...
  test('restores tracked prompt tree rows without rewriting stale show-all state', async ({
    electronApp,
    testSetup
  }) => {
