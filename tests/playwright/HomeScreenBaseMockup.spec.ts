...
describe('HomeScreenBase mockup', () => {
  ...
  test('previews workspace and dialog states without changing the live workspace', async ({ testSetup }) => {
    ...
    await expect(mockup.getByTestId('workspace-ready-path')).toHaveText('C:/Workspace')
    ...
    await expect(dialog.getByTestId('create-workspace-containing-folder-display')).toHaveText('C:/Workspace')
    await expect(dialog.getByTestId('create-workspace-final-path-display')).toHaveText('C:/Workspace\\DesignWorkspace')
    ...
    await expect(mockup.getByTestId('workspace-ready-path')).toHaveText('C:/Workspace\\DesignWorkspace')
